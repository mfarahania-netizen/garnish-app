  ...
  return (
    <Box style={{ minBlockSize: '100dvh', background: 'var(--g-color-bg-canvas)' }}>
      ...
      <Box style={{ position: 'sticky', insetBlockStart: 0, zIndex: 10, display: 'flex', alignItems: 'center', gap: 'var(--g-space-3)', flexWrap: 'wrap', paddingInline: 'var(--g-space-5)', paddingBlock: 'var(--g-space-3)', background: 'var(--g-color-bg-surface)', borderBlockEnd: '1px solid var(--g-color-border-subtle)' }}>
        <UnstyledButton type="button" onClick={() => navigate(-1)} aria-label="بازگشت" style={{ inlineSize: 40, blockSize: 40, flexShrink: 0, borderRadius: '50%', border: '1px solid var(--g-color-border-subtle)', background: 'var(--g-color-bg-surface)', color: 'var(--g-color-text-secondary)', display: 'inline-flex', alignItems: 'center', justifyContent: 'center' }}><IconChevronRight size={20} stroke={1.8} /></UnstyledButton>
