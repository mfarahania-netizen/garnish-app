      ...
      {mode === 'servings' ? (
        <Box style={{ marginBlockStart: 'var(--g-space-4)' }}>
          ...
          <Box style={{ display: 'flex', gap: 'var(--g-space-2)', marginBlockStart: 'var(--g-space-4)' }}>
            <UnstyledButton type="button" onClick={() => setMode(null)} style={{ flex: 1, minBlockSize: 48, borderRadius: 'var(--g-radius-input)', border: '1px solid var(--g-color-border-strong)', background: 'var(--g-color-bg-surface)', color: 'var(--g-color-text-primary)', fontFamily: 'var(--g-font-fa)', fontSize: 'var(--g-font-size-14)', fontWeight: 600 }}>فعلاً تغییر نده</UnstyledButton>
