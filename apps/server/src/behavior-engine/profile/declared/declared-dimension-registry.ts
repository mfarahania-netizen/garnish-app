...
export const DECLARED_DIMENSIONS: readonly DeclaredDimensionDef[] = [
  ...
  def({ key: 'dietary.allergies_intolerances', group: 'dietary', label: 'Declared allergies & intolerances (binary)', valueType: 'multi_select', sensitive: true, consentPurpose: 'core', priority: 10, persistence: 'user_allergy', safeExplanationTemplate: 'Each item you declare is used as a binary safety exclusion to keep conflicting ingredients out of suggestions; no intensity level is stored.' }),
