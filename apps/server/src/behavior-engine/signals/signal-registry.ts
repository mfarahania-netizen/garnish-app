...
export const SIGNAL_REGISTRY: readonly SignalRegistryEntry[] = [
  ...
  mk({ signalKey: 'taste.explicit_like', description: 'Explicit lightweight like on a recipe (distinct from saving it).', allowedEventFamilies: ['recipe'], allowedEventTypes: ['recipe_liked'], direction: 'positive', valueType: 'score', explainabilityTemplate: 'Based on the recipes you explicitly like.' }),
